                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                           ...
                           <li>
                            <a href="<?php echo base_url('admin/Provedores') ?>"><i class="fa fa-user fa-fw"></i>Provedores</a>
                        
                        </li>
                        
                        <li>
                            <a href="<?php echo base_url('admin/Clientes') ?>"><i class="fa fa-user fa-fw"></i>Clientes</a>
                        ...
                        <li>
                            <a href="<?php echo base_url('admin/Usuarios') ?>"><i class="fa fa-user fa-fw"></i>Usuarios</a>
                        
                        </li>

                   
                        <li>
                            <a href="<?php echo base_url('admin/Movimientos') ?>"><i class="fa fa-car fa-fw"></i>Movimientos en Procesos</a>
