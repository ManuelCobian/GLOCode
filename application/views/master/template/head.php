            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                          ...
                          <li><a href="<?php echo base_url('master/Profile') ?>"><i class="fa fa-user fa-fw"></i>Perfil</a>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                           ...
                           <li>
                            <a href="<?php echo base_url('master/Provedores') ?>"><i class="fa fa-user fa-fw"></i>Provedores</a>
