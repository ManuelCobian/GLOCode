            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                         ...
                         <li><a href="<?php echo base_url('users/Profile') ?>"><i class="fa fa-user fa-fw"></i>Perfil</a>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                          ...
                          <li>
                           ...
                           <li>
                            <a href="<?php echo base_url('users/Provedores') ?>"><i class="fa fa-user fa-fw"></i>Provedores del sistema</a>
